  ...
  const faqs = [
    {
      ...
      a: 'بله. سیستم قیمت‌گذاری اینانا به صورت لحظه‌ای به نرخ اتحادیه طلا متصل است. در لحظه ثبت سفارش، قیمت هر قطعه بر اساس آخرین نرخ هر گرم طلای ۱۸ عیار، اجرت ساخت مشخص و مالیات مصوب محاسبه و قفل می‌شود.',
    },
    {
